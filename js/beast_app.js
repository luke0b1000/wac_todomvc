/**
 * BEAST MODE: TODO MVC
 * It doesn't matter the order of this.saveToLocalStorage(); is before or after this.render();
 *		saveToLocalStorage: function() {
 *			util.store('todos-jquery', this.todos);		// could over do it with util.store.call({}, 'todos-jquery', this.todos);
 *		},
 */
